...
1. **Create Consensus** - The 'Accepted Proposals' section is a synthesized set of roadmaps or proposals that have been accepted by Gitcoin governance processes.  
...
You are at **endgame.work** - which describes the rules for a marketplace of ideas + links proposals for Gitcoin's endgame.  
